// Chave para identificar os dados salvos pelo localStorage.
const STORAGE_KEY = "prompts_storage"

//Carrega os dados salvos do localStorage e exibe no console
const state = {
  prompts: [],
  selectedID: null,
}
...
// Atualiza o estado do wrapper com base no conteúdo do elemento editável
...
function init() {
  ...
  //Estado inicial: sidebar aberta ou fechada
  elements.sidebar.classList.remove("open")
  elements.sidebar.classList.remove("collapsed")

  // Eventos para abrir/fechar a sidebar
